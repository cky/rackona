...
(define-jni-interface _JNIEnv
  ((reserved0)
   ...
   (GetStringChars _jstring (isCopy : _jboolean) -> (chars : _pointer)
                   -> (values chars isCopy))
   (ReleaseStringChars _jstring _pointer -> _void)

   (NewStringUTF _string/utf-8 -> _jstring)
   (GetStringUTFLength _jstring -> _jsize)
   (GetStringUTFChars _jstring (isCopy : _jboolean) -> (chars : _pointer)
                      -> (values chars isCopy))
   ...
   (GetBooleanArrayElements _jbooleanArray (isCopy : _jboolean)
                            -> (elems : _pointer) -> (values elems isCopy))
   (GetByteArrayElements _jbyteArray (isCopy : _jboolean)
                         -> (elems : _pointer) -> (values elems isCopy))
   (GetCharArrayElements _jcharArray (isCopy : _jboolean)
                         -> (elems : _pointer) -> (values elems isCopy))
   (GetShortArrayElements _jshortArray (isCopy : _jboolean)
                          -> (elems : _pointer) -> (values elems isCopy))
   (GetIntArrayElements _jintArray (isCopy : _jboolean)
                        -> (elems : _pointer) -> (values elems isCopy))
   (GetLongArrayElements _jlongArray (isCopy : _jboolean)
                         -> (elems : _pointer) -> (values elems isCopy))
   (GetFloatArrayElements _jfloatArray (isCopy : _jboolean)
                          -> (elems : _pointer) -> (values elems isCopy))
   (GetDoubleArrayElements _jdoubleArray (isCopy : _jboolean)
                           -> (elems : _pointer) -> (values elems isCopy))
   ...
   (GetPrimitiveArrayCritical _jarray (isCopy : _jboolean)
                              -> (array : _pointer) -> (values array isCopy))
   (ReleasePrimitiveArrayCritical _jarray _pointer _jint -> _void)

   (GetStringCritical _jstring (isCopy : _jboolean) -> (cstring : _pointer)
